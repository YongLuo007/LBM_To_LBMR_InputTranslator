...
test_dir("C:/Users/yonluo/Documents/GitHub/landisToSpadesTranslator/landisToSpadesTranslator/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/yonluo/Documents/GitHub/landisToSpadesTranslator/landisToSpadesTranslator/tests/testthat/test-template.R")
